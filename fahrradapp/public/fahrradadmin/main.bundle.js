...
var AddfahrradComponent = /** @class */ (function () {
    ...
    AddfahrradComponent.prototype.onSubmit = function () {
        ...
        this.http.post('http://localhost:8082/postnewfahrrad', this.form.value).subscribe(function (response) {
...
module.exports = "\n\n\n<form [formGroup]=\"form\" (ngSubmit)=\"onSubmit()\">\n\n  <div class=\"row\">\n    <div class=\"col-md-4 col-sm-6 col-xs-12\">\n      <div class=\"form-group\">\n        <label for=\"name\">Name</label>\n        <input\n          type=\"text\"\n          id=\"name\"\n          formControlName=\"name\"\n          class=\"form-control\"\n        >\n      </div>\n    </div>\n\n\n\n    <div class=\"col-md-4 col-sm-6 col-xs-12\">\n      <div class=\"form-group\">\n        <label for=\"price\">Preis</label>\n        <input\n          type=\"text\"\n          id=\"price\"\n          formControlName=\"price\"\n          class=\"form-control\"\n        >\n      </div>\n    </div>\n  </div>\n\n  <div class=\"row\">\n    <div class=\"col-md-4 col-sm-6 col-xs-122\">\n      <div class=\"form-group\">\n        <label for=\"descriptionShort\">Beschreibung (kurz)</label>\n        <input\n          type=\"text\"\n          id=\"descriptionShort\"\n          formControlName=\"descriptionShort\"\n          class=\"form-control\"\n        >\n      </div>\n    </div>\n\n    <div class=\"col-md-4 col-sm-6 col-xs-12\">\n      <div class=\"form-group\">\n        <label for=\"descriptionLong\">Beschreibung (lang)</label>\n        <input\n          type=\"text\"\n          id=\"descriptionLong\"\n          formControlName=\"descriptionLong\"\n          class=\"form-control\"\n        >\n      </div>\n    </div>\n  </div>\n\n  <div class=\"row\">\n    <div class=\"col-lg-12\">\n      <div class=\"form-group\">\n\n        <button class=\"btn btn-success\" type=\"button\" onclick=\"document.getElementById('image').click()\">\n          <input\n            type=\"file\"\n            id=\"image\"\n            formControlName=\"image\"\n            style=\"display:none\"\n            (change)=\"onFileChange($event)\"\n          >\n          Bild auswählen</button>\n      </div>\n      <img class=\"card-img-top\" *ngIf=\"!checkInputFile\" [src]=\"'data:jpg;base64,' +  myImage | unsafe \" alt=\"Fahrrad\" style=\"width:50px; height: 50px;\">\n      <br *ngIf=\"!checkInputFile\">\n      <br *ngIf=\"!checkInputFile\">\n    </div>\n  </div>\n  <div class=\"row\">\n    <div class=\"col-lg-12\">\n      <button type=\"submit\" [disabled]=\"form.invalid || checkInputFile\" class=\"btn btn-success\">Aktualisieren</button>\n    </div>\n  </div>\n  <br>\n  <br>\n  <br>\n</form>\n\n\n"
...
var FahrradDetailComponent = /** @class */ (function () {
    ...
    FahrradDetailComponent.prototype.onSubmit = function () {
        ...
        this.http.post('http://localhost:8082/editfahrrad', this.form.value).subscribe(function (response) {
...
var EditfahrradComponent = /** @class */ (function () {
    ...
    EditfahrradComponent.prototype.onDelete = function () {
        ...
        this.http.post('http://localhost:8082/fahrraddelete', myBody).subscribe(function (response) {
...
var FahrradService = /** @class */ (function () {
    ...
    FahrradService.prototype.getAllFahrrads = function () {
        var _this = this;
        this.http.get('http://localhost:8082/getallfahrrads').subscribe(function (response) {
...
module.exports = "<nav class=\"navbar navbar-expand-sm bg-dark navbar-dark\">\n  <ul class=\"navbar-nav navbaritems navbarwidth\">\n    <li routerLinkActive=\"active\"><a routerLink=\"/\">Fahrräder bearbeiten</a></li>\n    <li routerLinkActive=\"active\"><a routerLink=\"/addfahrrad\">Fahrrad hinzufügen</a></li>\n  </ul>\n</nav>\n<br>\n"
