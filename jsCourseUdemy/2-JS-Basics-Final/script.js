...
john.push('blue'); //adds something to the end
john.unshift('Mr.'); //adds something to the beginning
john.pop(); //removes value from the end
john.shift(); // removes first value
john.indexOf('Smith');
console.log(john);
